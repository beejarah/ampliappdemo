/**
 * USDC Monitor Action for Tenderly Dashboard
 * Copy and paste this directly into the Tenderly dashboard when creating an action
 */

// Dashboard handler format (exports.handler instead of named export)
